...
- (void)initiateBackgroundUpload:(NSURL *)fileUrl headers:(NSDictionary *)headers
{
...
{
    // Save the mappings
    [self.store saveUploadTaskId:uploadTask.taskIdentifier withBackgroundUploadId:backgroundUpload.id];
}
